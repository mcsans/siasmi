...
<div class="container-fluid">
	...
	<div class="card">
		<?= form_open_multipart(); ?>
		<input type="hidden" class="form-control" name="id" value="<?= $ukm['id']; ?>">
		<input type="hidden" name="gambar" value="<?= $ukm['gambar']; ?>">
		<div class="card-body">
			<div class="row">
				<div class="form-group col-6">
					<label for="nama">Nama</label>
					<input type="text" class="form-control" id="nama" name="nama" value="<?= $ukm['nama']; ?>">

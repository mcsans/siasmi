...
<a class="scroll-to-top rounded" href="<?= base_url(); ?>assets/SBAdmin/#page-top">
	...
	<div class="modal-dialog" role="document">
		<div class="modal-content">
			...
			<div class="modal-footer">
				...
				<a class="btn btn-primary" href="<?= base_url(); ?>assets/SBAdmin/login.html">Logout</a>
			</div>
		</div>
	</div>
</div>
...
<script src="<?= base_url(); ?>assets/SBAdmin/plugins/bs-custom-file-input/bs-custom-file-input.min.js"></script>
